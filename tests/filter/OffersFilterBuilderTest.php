...
class OffersFilterBuilderTest extends TestCase
{
    public function testToArray()
    {
        ...
        $builder->categoryId(1)->isActive()->limit(10)->notHidden()->offset(20)->orderByField('field');
        $this->assertEquals(['categoryId' => 1, 'active' => 1, 'hidden' => 0, 'limit' => 10, 'offset' => 20, 'orderByField' => 'field'], $builder->toArray());
    }
